...
config.GOOGLE_RETURN_URL = process.env.GOOGLE_RETURN_URL || 'http://127.0.0.1:8080/auth/google/return';
config.GOOGLE_REALM = process.env.GOOGLE_REALM || 'http://127.0.0.1:8080/';
